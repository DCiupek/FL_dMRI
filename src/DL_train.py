...
from train_evaluate import train, predict
import wandb
...
parser.add_argument('--key', type=str, help='Weights & Biases key, required if you want to use Weights & Biases.', required=False)
